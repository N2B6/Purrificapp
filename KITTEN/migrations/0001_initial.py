    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet_type', models.CharField(choices=[('dog', 'Dog'), ('cat', 'Cat'), ('bird', 'Bird'), ('fish', 'Fish'), ('rodent', 'Rodent'), ('exotic', 'Exotic')], default='dog', max_length=50)),
                ('age', models.FloatField()),
                ('breed', models.CharField(max_length=100)),
                ('description', models.TextField(max_length=200)),
                ('image', models.ImageField(null=True, upload_to='KITTEN/images')),
